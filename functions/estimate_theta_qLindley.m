function theta = estimate_theta_qLindley(sample, max_intervals, q)
% -------------------------------------------------------------------------
% Estimate the parameter theta of a Lindley q-distribution
...
% -------------------------------------------------------------------------
    ...
    u1 = @(q_theta) (q_theta + q_number(2, q)) / ...
                    (q_theta * (q_theta + 1));

    u2 = @(q_theta) q_number(2, q) * (q_theta + q_number(3, q)) / ...
                   (q_theta^2 * (q_theta + 1));
